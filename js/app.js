(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-carousel__body")) new swiper_core_Swiper(".slider-carousel__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            lazy: true,
            navigation: {
                prevEl: ".slider-carousel .slider-arrow--prew",
                nextEl: ".slider-carousel .slider-arrow--next"
            }
        });
        if (document.querySelector(".slider-testimonial__body")) new swiper_core_Swiper(".slider-testimonial__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            lazy: true,
            navigation: {
                prevEl: ".slider-testimonial .slider-arrow--prew",
                nextEl: ".slider-testimonial .slider-arrow--next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2
